...
- Pour cela, 
    ...
    - soit [ChatOllama](https://python.langchain.com/docs/integrations/chat/ollama/) - option gratuite mais demandant un ordinateur suffisamment puissant - ;
...
- [Mise à niveau Smart-Meter](../projet_equipe.md) 
